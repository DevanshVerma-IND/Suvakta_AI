    ...
    <div className="step-preview">
      <div style={{ marginTop: 20, background: "rgba(255,255,255,0.12)", borderRadius: 14, padding: "14px 16px" }}>
        ...
        <div style={{ fontSize: 11, color: "rgba(255,255,255,0.85)", fontWeight: 500, marginBottom: 10, lineHeight: 1.5 }}>
          suvakta.app wants access to your
        </div>
    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh", color: "var(--text)" }}>
      ...
      >
        ...
        <div className="sf-card anim-fadeIn">
          ...
          <p className="sf-bottom-text">Suvakta</p>
          <div className="sf-content">
            <div className="sf-logo">
              <span className="sf-logo1">Su</span>
              <span className="sf-logo2">vakta</span>
      ...
      <section id="how" style={{ maxWidth: 1100, margin: "0 auto", padding: "100px 40px 0" }}>
        ...
        <div className="step-cards">
          ...
          <div className="step-card" style={{ background: "#1a2428" }}>
            ...
            <div style={{ fontSize: 14, color: "rgba(255,255,255,0.60)", lineHeight: 1.65 }}>
              Suvakta immediately analyses your voice and body language.
            </div>
            <PreviewWaveform />
          </div>
      ...
      <footer style={{ borderTop: "1px solid var(--border-light)", padding: "24px 40px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <span style={{ fontSize: 14, letterSpacing: "-0.3px" }}>
          <span style={{ fontWeight: 500, color: "var(--text-muted)" }}>Su</span><span style={{ fontWeight: 800, color: "var(--gold)" }}>vakta</span>
        </span>
        <span style={{ fontSize: 13, color: "var(--text-subtle)" }}>2026 Suvakta</span>
      </footer>
    </div>
  );
}
